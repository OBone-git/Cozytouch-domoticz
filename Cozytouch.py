...
def maj_device(data,name,p,x):
    ...
    if name == dict_cozytouch_devtypes.get('PAC zone component') :
        ...
        gestion_consigne(u'Manuel',classe.get(u'url'),classe.get(u'nom'),classe.get(u'idx_cons_temp_manu'),value_by_name(data,x,u'core:DerogatedTargetTemperatureState'),setting_consigne_zone)
        # Et application d'une durée fixe de dérogation
        # Cmd :setDerogationTime / State : io:DerogationRemainingTimeState (à 480mins dans dump_cozytouch_consigne 19.5_8h)
        # Passer une commande setDerogationOnOffState à on pour activer le mode dérogation
